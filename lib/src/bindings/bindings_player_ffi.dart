...
typedef LooperPlaybackStartedCallbackNative =
    ffi.Void Function(
...
typedef LooperPlaybackStartedCallbackDart =
    void Function(int soundHash, int handle, double durationSeconds);

/// Static storage for the Dart looper playback started callback.
void Function(int, int, double)? _looperPlaybackStartedCallback;

/// Native callback that forwards looper playback started events to Dart.
...
typedef WaveformExtractedCallbackNative =
    ffi.Void Function(ffi.UnsignedInt soundHash, ffi.Int error);
...
class FlutterSoLoudFfi extends FlutterSoLoud {
  ...
  PlayerErrors initEngineSlave(
    ...
    final ret = _initEngineSlave(sampleRate, bufferSize, channels.count);
    return PlayerErrors.values[ret];
  }

  late final _initEngineSlavePtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Int32 Function(ffi.UnsignedInt, ffi.UnsignedInt, ffi.UnsignedInt)
        >
      >('initEngineSlave');
  late final _initEngineSlave = _initEngineSlavePtr
  ...
  late final _configureNativeAudioSinkPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            ffi.UnsignedInt,
        ...
        >
      >('soloud_configureNativeAudioSink');
  late final _configureNativeAudioSink = _configureNativeAudioSinkPtr
      .asFunction<
        void Function(
          int,
          ffi.Pointer<ffi.Pointer<ffi.Void>>,
  ...
  late final _disableNativeAudioSink = _disableNativeAudioSinkPtr
  ...
  late final _isNativeAudioSinkActive = _isNativeAudioSinkActivePtr
      .asFunction<bool Function()>();
  ...
  late final _getLooperBridgeFunction = _getLooperBridgeFunctionPtr
  ...
  void setLooperPlaybackStartedCallback(
    ...
    _looperCallableInstance ??=
        ffi.NativeCallable<LooperPlaybackStartedCallbackNative>.listener(
  ...
  late final _setLooperPlaybackStartedCallbackPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            ffi.Pointer<
  ...
  late final _setLooperPlaybackStartedCallback =
      _setLooperPlaybackStartedCallbackPtr
          .asFunction<
            void Function(
              ffi.Pointer<
                ffi.NativeFunction<LooperPlaybackStartedCallbackNative>
  ...
  late final _setAECOutputCallback = _setAECOutputCallbackPtr
      .asFunction<void Function(ffi.Pointer<ffi.Void>)>();
  ...
  late final _clearAECOutputCallbackPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>(
        'clearAECOutputCallback',
      );
  late final _clearAECOutputCallback = _clearAECOutputCallbackPtr
      .asFunction<void Function()>();
  ...
  void setWaveformExtractedCallback(
    ...
    _waveformCallableInstance ??=
        ffi.NativeCallable<WaveformExtractedCallbackNative>.listener(
  ...
  late final _setWaveformExtractedCallbackPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            ffi.Pointer<ffi.NativeFunction<WaveformExtractedCallbackNative>>,
          )
        >
      >('setWaveformExtractedCallback');
  late final _setWaveformExtractedCallback = _setWaveformExtractedCallbackPtr
      .asFunction<
        void Function(
          ffi.Pointer<ffi.NativeFunction<WaveformExtractedCallbackNative>>,
        )
  ...
  late final _extractWaveformAsyncPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            ffi.UnsignedInt,
        ...
        >
      >('extractWaveformAsync');
  late final _extractWaveformAsync = _extractWaveformAsyncPtr
      .asFunction<
